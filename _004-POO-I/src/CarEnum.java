public class CarEnum {
    ...
    public CarEnum(String manufacturer) {
    ...
    public CarEnum(String manufacturer, String model){
        this();
        this.manufacturer = manufacturer;
        this.model = model;
    }
...
// It is possible to have multiple constructors (constructor overload)
    ...
    public CarEnum(String manufacturer, String model, Color color) {
        this(manufacturer, model); // re-using the previous constructor
        this.color = color;
    }

    public CarEnum(String manufacturer, String model, Color color, double cc) {
        this(manufacturer, model, color);
        this.cc = cc;
    }

    public CarEnum(String manufacturer, String model, Color color, double cc, int tankCapacity) {
    ...
    public static void setStaticTankCapacity(int staticTankCapacity) {
        CarEnum.staticTankCapacity = staticTankCapacity;
    }
    ...
    public static float calculateStaticConsumption(int km, int fuelPercentage){
        return km/((CarEnum.staticTankCapacity *fuelPercentage)/100f);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ( !(obj instanceof CarEnum) ) {
            return false;
        }

        CarEnum a = (CarEnum) obj;
